...
void adc_Config(ADC_Config_t *adcConfig){
	...
	{
		ADC1->CR1 &= ~(ADC_CR1_RES_0); // Desplazamiento de 11 negado}
...
void startContinousADC(void){
	...
	/* Iniciamos un ciclo de conversión ADC */
	 ...
	 ADC1->CR2 |= ADC_CR2_SWSTART; // Para varios ciclos al tiempo
...
//(uint8_t)
		...
		// Hacemos el llamado a la función que se ejecutará en el main OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOJOOOOO
