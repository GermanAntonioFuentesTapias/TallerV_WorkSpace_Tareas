 ...
 *      Author Original: German Antonio Fuentes Tapias
 */
...
void extInt_Config(EXTI_Config_t *extiConfig){
	...
	RCC ->APB2ENR |= RCC_APB2ENR_SYSCFGEN; // pIN 14 Del Enr APB2
	...
	EXTI -> IMR |= ( EXTI_IMR_IM0 << ( extiConfig -> pGPIOHandler -> GPIO_PinConfig.GPIO_PinNumber));
...
/*   L  L  A  M  A  D  O     D E  C A L L   B A C K*/
