...
#define   SPI_BAUDRATE_FPCLK_26   7
...
typedef struct
{
	uint8_t  SPI_mode;               // Define los 4 diferentes modos que se pueden configurar
	uint8_t  SPI_baudrate;           // Define la velocidad que maneja el SPI con respecto al prescaler
